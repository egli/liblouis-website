self.onmessage = (function() {
	CMD = {
		importLib: function(data) {
			importScripts("https://rawgit.com/liblouis/js-build/master/build-no-tables-utf32.js");
					...
					if (httpReq.readyState === 4 && (httpReq.status === 200 || httpReq.status == 0)) {
						...
						for (i = 0; i < lines.length; i++) {
							...
							if (line.charAt(0) === '*' || line.charAt(0) === ' ') {
								...
								tableUrl = new URL(tablePath, tableIndex).href;
						...
						liblouis.enableOnDemandTableLoading("https://raw.githubusercontent.com/liblouis/liblouis/master/tables/");
